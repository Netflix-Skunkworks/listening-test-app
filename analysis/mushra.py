...
def plot_mushra_results(listeners_dict,
                        test_info_dict,
                        output_dir,
                        plot_subjects=True,
                        plot_stimuli=True,
...
if __name__ == '__main__':
    data_dir = "./resources/mushra_example_results/"
    output_dir = "./output/"
    listeners, test_info = parse_xml_results(data_dir)
    plot_mushra_results(listeners, test_info, output_dir, plot_subjects=False, plot_stimuli=False)
